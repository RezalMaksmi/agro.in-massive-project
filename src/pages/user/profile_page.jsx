          ...
          <div className="flex flex-col items-center md:items-start md:w-1/3">
            ...
            <div className="text-center md:text-left">
              <div className="  border-solid border-l-8 border-primary max-sm:border-hidden">
                <h1 className=" mx-4 text-2xl text-white font-semibold ">Halo {userData.name}!</h1>
              </div>
          ...
          <div className="mt-6 md:mt-0 md:ml-6 md:w-2/3">
            <div className="bg-gray-50 px-12 py-4 rounded-lg shadow-inner">
              ...
              <div className="flex justify-end">
                <button className="bg-primary text-white px-4 py-2 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 " onClick={handleEditProfile}>
                  Edit Profil
                </button>
              </div>
            </div>
      ...
      <Modal showModal={showModal} onClose={handleCloseModal}>
        ...
        <form onSubmit={handleSubmit}>
          <div className="flex items-center mb-4">
            <img className="w-20 h-20 rounded-full mr-4" src={profileMulyadi} alt="Profile" />
            <button type="button" className="bg-primary text-white px-4 py-2 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 ">
              Cari Gambar
            </button>
          </div>
          <div className="mb-4">
            <label className="block text-sm font-medium text-gray-700">Nama:</label>
            <input type="text" name="name" className="mt-1 p-2 rounded-full bg-slate-200 w-full" value={userData.name} onChange={handleInputChange} />
          </div>
          <div className="mb-4">
            <label className="block text-sm font-medium text-gray-700">Email:</label>
            <input type="email" name="email" className="mt-1 p-2 rounded-full bg-slate-200 w-full" value={userData.email} onChange={handleInputChange} />
          </div>
          <div className="mb-4">
            <label className="block text-sm font-medium text-gray-700">No Telepon:</label>
            <input type="text" name="phone" className="mt-1 p-2 rounded-full bg-slate-200 w-full" value={userData.phone} onChange={handleInputChange} />
          </div>
          <div className="mb-4">
            <label className="block text-sm font-medium text-gray-700">Kata Sandi Baru:</label>
            <input type="password" name="newPassword" className="mt-1 p-2 rounded-full bg-slate-200 w-full" value={userData.newPassword || ""} onChange={handleInputChange} />
          </div>
          <div className="mb-4">
            <label className="block text-sm font-medium text-gray-700">Konfirmasi Kata Sandi Baru:</label>
            <input type="password" name="confirmNewPassword" className="mt-1 p-2 rounded-full bg-slate-200 w-full" value={userData.confirmNewPassword || ""} onChange={handleInputChange} />
          </div>
          <div className="flex justify-end">
            <button type="submit" className="bg-primary text-white px-4 py-2 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 ">
              Simpan
            </button>
          </div>
        </form>
      </Modal>
      <ConfirmModalProfile showModal={showConfirmModal} onClose={handleCloseConfirmModal} onConfirm={handleSaveChanges} />
    </div>
  );
};
