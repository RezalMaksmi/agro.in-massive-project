          ...
          >
            ...
            <div className="flex flex-col md:gap-10 gap-5 md:text-start text-center">
              ...
              <p className="md:text-xl text-base ">
                Agro.in merupakan platform layanan penyedia informasi aktual
                yang terintegrasi, yang bermanfaat bagi kegiatan industri petani
                untuk mengoptimalkan usaha pertanian. Tiga nilai yang ingin kami
                berikan untuk perkembangan pertanian Indonesia yaitu informasi,
                Inegritas, dan industri.
                <br />
                <br />
