...
const Footer = () => {
  return (
    <div className="w-full  rounded-t-[35px] bg-[#265c53] text-white">
      <div className="container lg:px-20 px-5 py-10 mx-auto grid md:grid-cols-4 gap-5">
        <div className="flex flex-col items-start ">
          ...
          <span className="text-lg mt-2">
            Layanan penyedia informasi aktual dan bermanfaat untuk meningkatkan
      ...
      <div className="bg-[#1A3D37] w-full flex justify-center items-center py-5">
